...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        "relative z-50 min-w-[8rem] overflow-hidden rounded-md border border-input bg-white text-foreground shadow-md dark:bg-neutral-900 dark:text-neutral-100 dark:border-neutral-700",
        position === "popper" &&
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none text-neutral-900 dark:text-neutral-100 data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      // Hover and highlight states for better contrast in dark mode
      "hover:bg-neutral-100 hover:text-neutral-900 dark:hover:bg-neutral-800 dark:hover:text-white",
      "data-[highlighted]:bg-neutral-100 data-[highlighted]:text-neutral-900 dark:data-[highlighted]:bg-neutral-800 dark:data-[highlighted]:text-white",
      className
    )}
    {...props}
  >
